...
namespace Kfstorm.LrcParser
{
    ...
    public class Lrc : ILrc
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Lrc"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Create a new new instance of the <see cref="ILrc"/> interface with the specified LRC text.
        /// </summary>
        /// <param name="lrcText">The LRC text.</param>
        /// <returns></returns>
        public static ILrc FromText(string lrcText)
        {
            ...
            return new Lrc(metadata, lyrics, true);
        }
    }
}
